...
- 🇪🇸 Español
- [🇺🇸 English](https://github.com/NikolaM-Dev/dotfiles)
...
[aquí](https://github.com/NikolaM-Dev/dotfiles/tree/master/.config/qtile).
...
y para interfaces gráficas como _pcmanfm_ necesitas **[gvfs](https://www.archlinux.org/packages/extra/x86_64/gvfs/)**:
...
Con _pcmanfm_ puedes abrir la basura desde el panel izquierdo, pero desde la
...
Sugiero empezar con
_Material-Black-Plum-1.9.3_ y _Material-Black-Plum-Suru-1.9.2_. Puedes encontrar
...
cd Downloads/
sudo pacman -S unzip
unzip Material-Black-Plum_1.9.3.zip
unzip Material-Black-Plum-Suru_1.9.2.zip
...
- [Qtile](https://github.com/NikolaM-Dev/dotfiles/tree/master/.config/qtile/README.es.md)
...
```bash
sudo pacman -S rofi pcmanfm flameshot firefox alacritty redshift scrot
```

Para configurar _rofi_,
[lee este README](https://github.com/NikolaM-Dev/dotfiles/tree/master/.config/rofi/README.es.md),
y para _alacritty_, [este](https://github.com/antoniosarosi/pycritty).
...
| **mod + e**         | lanzar explorador de archivos (pcmanfm)      |
| **mod + return**    | lanzar terminal (alacritty)                  |
| **mod + r**         | redshift                                     |
| **mod + shift + r** | parar redshift                               |
| **mod + s**         | captura de pantalla (flameshot)              |
| **mod + shift + s** | captura de pantalla con temporizador (scrot) |
...
| **[pcmanfm](https://wiki.archlinux.org/index.php/PCManFM)**           | Gestor de archivos gráfico         |
