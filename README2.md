...
![Qtile](./qtile/qtile.png)

**_Quick Links_**

- _Window manager configs_
  - [Qtile](https://github.com/NikolaM-Dev/.doftfiles/tree/main/qtile)
...
With _thunar_ you can open the trash clicking on the left panel, but on the command
line you can use:
...
and for _alacritty_, [this one](https://github.com/antoniosarosi/dotfiles/tree/master/.config/alacritty).
